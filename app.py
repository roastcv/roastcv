...
with col_left:
    resume_file = st.file_uploader(
        ...
        help="✅ Max 5 MB only. Text-based PDF or DOCX required — scanned/image PDFs cannot be read.",
        label_visibility="visible",
    )
    # Show custom size note (replaces confusing "200MB per file" Streamlit default)
